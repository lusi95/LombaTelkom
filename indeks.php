...
<html>
	...
	<body>
		...
		<div id="nav">
			<ul>
				<li id = "logo1"><a><img src = "images/logo copy.png"></a></li>
				<li class = "headertext"><a>Masuk</a></li>
			</ul>
					...
					<p></p>
						<div class="container">
						  <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12">
							<div class="portfolio-item">
										<div class="portfolio-thumb">
											<img src="images/event/standupithb.jpg" alt="Stand Up ITHB 2014">
											<div class="overlay-p">
												<a href="images/event/standupithb.jpg" data-rel="lightbox[portfolio]">
													<ul>
														<li>Stand Up Bazzar Management ITHB</li>
														<li></li>
														<li>-Stella Patricia-</li>
													</ul>
												</a>
